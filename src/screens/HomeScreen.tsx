      ...
      <div className="flex-1  md:grid flex flex-col md:grid-cols-2">
        ...
        <div className="items-center justify-center  flex">
          <div className="h-auto w-full mt-12 md:w-[34rem] flex-col gap-y-7 flex ">
            <h1 className="text-4xl tracking-normal md:text-left text-center ">
              La visioconférence haute qualité, maintenant disponible pour tous
            </h1>
            <h1 className="text-lg text-gray-500 tracking-wide md:text-left text-center">
                ...
                <Button
                  ...
                  className={`${
                    RoomId.length > 3
                      ...
                      : "text-gray-300"
                  }  bg-white hover:bg-white h-[3rem]`}
                >
                  Participer
                </Button>
              ) : null}
        ...
        <div className=" flex-col items-center justify-center flex">
          <div className=" w-full md:w-[34rem] justify-center h-auto flex items-center gap-x-4 ">
            <div
              ...
              className={`h-10 w-10 ${
                carouselIndex === 0 ? "" : "hover:bg-gray-200"
              } rounded-full items-center cursor-pointer flex justify-center`}
            >
              <IoIosArrowBack />
            </div>
            <img
            ...
            <div
              ...
              className={`h-10 w-10 ${
                carouselIndex === 2 ? "" : "hover:bg-gray-200"
              } rounded-full items-center cursor-pointer flex justify-center`}
            >
              <IoIosArrowForward />
            </div>
          ...
          <div className="w-full mb-3 md:w-[34rem] h-auto justify-center mt-2 flex  items-center gap-x-2 ">
            {[1, 2, 3].map((_, indx) => (
              <div
                className={`h-2 w-2 ${
                  carouselIndex !== indx ? "bg-gray-400" : "bg-blue-400"
                }  rounded-full`}
              ></div>
            ))}
          </div>
